...
@Component({
  selector: 'app-asistencia-list-search',
  templateUrl: './asistencia-list-search.component.html',
  styleUrls: ['./asistencia-list-search.component.css']
})
export class AsistenciaListSearchComponent implements OnInit {
  ...
  buscarAsistencias() {
    ...
    this.asistenciasService.readAsistencias(paramsSearch).subscribe((response: any) => {
